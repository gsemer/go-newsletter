...
type NewsletterService interface {
	Create(ownerID uuid.UUID, name, description string) (*Newsletter, error)
	Get(ownerID uuid.UUID) ([]*Newsletter, error)
}
...
type NewsletterRepository interface {
	Create(ctx context.Context, ownerID uuid.UUID, name, description string) (*Newsletter, error)
	Get(ctx context.Context, ownerID uuid.UUID) ([]*Newsletter, error)
}
